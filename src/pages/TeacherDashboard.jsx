      ...
      <div style={styles.page}>
        ...
        <div style={styles.shell}>
          <div style={styles.card}>
            ...
            <p style={styles.p}>Tu usuario no tiene rol MAESTRO.</p>
      ...
      <div style={styles.shell}>
        <div style={styles.topbar}>
          <div style={styles.brandRow}>
            ...
            <div>
              <div style={styles.kicker}>Panel del Maestro</div>
              <div style={styles.titleRow}>
                <h1 style={styles.h1}>Dashboard{user?.full_name ? ` - ${user.full_name}` : ""}</h1>
              </div>
              <div style={styles.sub}>Gestión de trámites y procesos</div>
            </div>
          </div>
        ...
        <div style={styles.menuGrid}>
          <button onClick={() => go("/teacher/procedures")} style={styles.menuCard}>
            <div style={styles.menuIcon}>📋</div>
            <div style={styles.menuTitle}>Trámites</div>
            <div style={styles.menuDesc}>Ver y procesar trámites asignados</div>
          </button>
        </div>
          ...
          <>
            ...
            <div style={styles.statsGrid}>
              <div style={styles.statCard}>
                ...
                <div style={styles.statValue}>{stats.pending_procedures || 0}</div>
              </div>

              <div style={styles.statCard}>
                <div style={styles.statLabel}>Trámites En Proceso</div>
                <div style={styles.statValue}>{stats.in_process_procedures || 0}</div>
              </div>

              <div style={styles.statCard}>
                <div style={styles.statLabel}>Trámites Aprobados</div>
                <div style={styles.statValue}>{stats.approved_procedures || 0}</div>
              </div>

              <div style={styles.statCard}>
                <div style={styles.statLabel}>Total Trámites</div>
                <div style={styles.statValue}>{stats.total_procedures || 0}</div>
              </div>
            </div>
          </>
        )}
